...
import {listPolicy,listSelected,setStateSelectedt,setStatePolicyList} from './policySlice'
    ...
    <Box mb="1em" display="flex" alignItems="center" gap="10px">
      ...
      <Box mb="2em">
        <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
            ...
            <Button onClick={showFilterBtn} leftIcon={<MdFilterList color={showFilter ? '#065BAA' : '' } />} colorScheme='#231F20' variant='outline' size={'sm'} color={showFilter ? '#065BAA' : '' }>
                        Apply Filter
                    </Button>
