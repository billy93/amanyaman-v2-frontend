...
import {FillTravellersData,setTravellersData,selectManualInput,selectedTravelInsurance,setSelectTravelInsurancePlan,selectTravelInsurance,setFormStateCoverageType,setFormStateTravellerType,setFormStateTotalPass,setFormStateDestinationCountry,setFormStateStartDate} from '../quotaSearchSlice'
import {
RadioGroup,
Radio,
Textarea,
  ...
  const formatInputValues = () => {
    ...
    return (
        <Box border={'1px'} borderColor="#ebebeb" >
            <Modal size="lg" blockScrollOnMount={false} closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose}>
                <ModalOverlay />
                <ModalContent>
                   ...
                   <Box >
                    ...
                    <Box className='floating-form'>
                      <Box className='floating-label'>
                        <Select className="floating-select" placeholder='' defaultValue={type}  h="48px" onChange={handleSelectType}>  
                          <option value=""></option>
                          <option value="Adult">Adult</option>
                          <option value="Child">Child</option>
                        </Select>
                        <span className="highlight"></span>
                        <FormLabel fontSize="12" pt="1.5" style={{ transform: isActiveSelectCountry || type !=="" ? "translate(0, -19px) scale(0.75)": "",color: isActiveSelectCountry || type !=="" ?"#065baa" :"", fontSize:"14px" }} fontFamily={'Mulish'}>Select Status</FormLabel>
                       </Box>
                    </Box>
                    {/* It is important that the Label comes after the Control due to css selectors */}
                </FormControl>
                   ...
                   <Box>
                        <RadioGroup defaultValue={select} onChange={onSelect}>
                            <Stack spacing={4} direction='column'>
                                <Radio value='new'><Text as="p" fontSize={'sm'} fontFamily={'Mulish'}>New Traveller</Text></Radio>
                                <Radio value='existing'><Text as="p" fontSize={'sm'} fontFamily={'Mulish'}>Existing Traveller</Text></Radio>
                             </Stack>
                         </RadioGroup>
                    </Box>
                    {
                        select === 'new' ? (
                            ...
                            <Box className='floating-form'>
                            <Box className='floating-label'>
                                <Select className="floating-select" placeholder='' defaultValue={typeStatus}  h="48px" onChange={handleSelectTypeStatus}>  
                                <option value="Mr">Mr</option>
                                <option value="Mrs">Mrs</option>
                                <option value="Ms">Ms</option>
                                </Select>
                                <span className="highlight"></span>
                                <FormLabel fontSize="12" pt="1.5" style={{ transform: isActiveSelectCountry || type !=="" ? "translate(0, -19px) scale(0.75)": "",color: isActiveSelectCountry || type !=="" ?"#065baa" :"", fontSize:"14px" }} fontFamily={'Mulish'}>Select Type</FormLabel>
                            </Box>
                            </Box>
                            {/* It is important that the Label comes after the Control due to css selectors */}
                        </FormControl>
                        ...
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={firstName} onChange={setFirstNames} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">FirstName</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                                     <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={lastName} onChange={setLastNames} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        ...
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                                    ...
                                    <Box>
                        <Text as="p" fontFamily={'Mulish'} color="#065BAA" pl="5px" style={{fontSize:"12px"}}>As on ID Card/passport/driving license (without degree or special characters)</Text>
                    </Box>
                    <Box display={'flex'} gap="5px" mt="10px">  
                            ...
                            />
                        <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={placeOfBirth} onChange={setPlaceOfBirths} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5"> Place Of Birth</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                    </Box>
                     <Box w={{base:"100%", md:"365px"}} pb="20px">
                        <FormControl variant="floating" id="first-name" isRequired  fontFamily={'Mulish'} mt="14px"> 
                            <Textarea placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={address} onChange={setAddresss} h="48px" />
                            <FormLabel fontSize="12" pt="1.5" className={ isActive ? "Active" : ""}  fontFamily={'Mulish'} style={{fontSize:'14px'}}>Address</FormLabel>
                            {/* It is important that the Label comes after the Control due to css selectors */}
                        </FormControl>
                        </Box>
                            <Box display={'flex'} gap="5px">
                                     <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={email} onChange={setEmailAddress} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">Email Address</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                                     <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={phoneNumber} onChange={setPhoneNumbers} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">Phone Number</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                                    </Box>  
                                    <Box mt="1em">
                                         <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={pasportNumber} onChange={setPasportNumbers} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">Pasport Number</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                                    </Box>
                            </>
                            ...
                            <FormControl variant="floating" id="first-name" isRequired >
                                <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={searchTraveller} onChange={setSearchTravellers} h="48px"/>
                                {/* It is important that the Label comes after the Control due to css selectors */}
                                <FormLabel fontSize="12" pt="1.5"> Search Traveller</FormLabel>
                                {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                            </FormControl>
                            <DatePicker
                            value={dateBirth}
             ...
             <Box  border={'1px'} borderColor="#ebebeb" p="12px" display="flex" justifyContent={'space-between'} alignItems="center">
                ...
                <Box position={'relative'} m="auto">
                    <Heading variant="primary" as="h4" size="md"style={{fontSize:'18px'}} fontSize="sm" color="#065BAA" textAlign={'center'}>Fill in Travellers Data </Heading>
                </Box>
            </Box>
            <Box display={'flex'} >
                <Box display={'flex'} flexDirection={'column'} w={{base:"100%", md:"30%"}} border={'1px solid #ebebeb'} m="1em">
                <Box bg="#F0F3F8" p="15px">
                <Box display="flex" justifyContent={'flex-start'} alignItems={'center'} pt="15px" >
                    ...
                    <Box display={'flex'} justifyContent={'center'} flexDirection={'column'}>
                        ...
                        <Text as="b" size={'sm'} fontFamily={'Mulish'} color="#065BAA" style={{fontSize:"14px"}}>
                ...
                <Box w="70%" p="1em">
                    <Box gap="10px" display={'flex'} w={{base:"100%"}}>
                        <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={travellerName} onChange={handleUserChange} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">Fullname</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                    <FormControl variant="floating" id="first-name" isRequired >
                        <Input placeholder=" " _placeholder={{ opacity: 1, color: 'gray.500' }} value={travellerName} onChange={handleUserChange} h="48px"/>
                        {/* It is important that the Label comes after the Control due to css selectors */}
                        <FormLabel fontSize="12" pt="1.5">NIK</FormLabel>
                        {/* {isErrorUser ==='' && <FormErrorMessage>Your Username is invalid</FormErrorMessage>} */}
                    </FormControl>
                    </Box>
                    {
                        listTravellers?.listTravellers.map((travellers, i) => {
                            return (
                                ...
                                <AccordionItem border={'1px solid #ebebeb'} borderRadius={'5px'}>
                                    <h2 style={{marginBottom:"0"}}>
                                    <Box as="div" role="group">
                                        <AccordionButton  _groupHover={{
                                            boxShadow:"0px 0px 3px 3px rgba(153, 180, 206, 0.2)",
                                            transition:".2s",
                                            bg:"white",
                                            borderRadius:"5px"
                                            ...
                                            <AccordionIcon />
                                                ...
                                                <IconButton _groupHover={{
                                                    color:"#3182ce"
                                                }} bg="white" icon={<MdCreate size="1em" />} onClick={handleEditTravellersData}/>
                                                </Box>
                                                </AccordionButton>
                                    </Box>
                                    </h2>
                                                ...
                                                <AccordionPanel pb={4}>
                                                    <Box bg="white" p="10px">
                                                        <Box display={'flex'} justifyContent={'flex-start'} alignItems={'center'} boxSizing='borderBox' borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w={'50%'} fontFamily={'Mulish'} style={{fontSize:'14px'}}>Full Name</Text>
                                                            <Text as="p" w={'50%'} fontFamily={'Mulish'} style={{ fontSize: '12px' }} pl="5px">{travellers.fullName }</Text>
                                                        </Box>
                                                        <Box display={'flex'} justifyContent={'lex-start'} alignItems={'center'} borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w="50%" fontFamily={'Mulish'} style={{fontSize:'14px'}}>Email Address</Text>
                                                            <Text as="p" w="50%" fontFamily={'Mulish'} style={{ fontSize: '12px' }} pl="5px">{travellers.emailAddress }</Text>
                                                        </Box>
                                                        <Box display={'flex'} justifyContent={'lex-start'} alignItems={'center'} borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w="50%" fontFamily={'Mulish'} style={{fontSize:'14px'}}>Phone Number</Text>
                                                            <Text as="p" w="50%" fontFamily={'Mulish'} style={{ fontSize: '12px' }} pl="5px">{travellers.phoneNumber }</Text>
                                                        </Box>
                                                        <Box display={'flex'} justifyContent={'lex-start'} alignItems={'center'} borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w="50%" fontFamily={'Mulish'} style={{fontSize:'14px'}}>Passport Number</Text>
                                                            <Text as="p" w="50%" fontFamily={'Mulish'} style={{ fontSize: '12px' }} pl="5px">{travellers.pasportNumber }</Text>
                                                        </Box>
                                                        <Box display={'flex'} justifyContent={'lex-start'} alignItems={'center'}borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w="50%" fontFamily={'Mulish'} style={{fontSize:'14px'}}>Date Of Birth</Text>
                                                            <Text as="p" w="50%" fontFamily={'Mulish'} style={{fontSize:'12px'}} pl="5px">{travellers.dateOfBirth}</Text>
                                                        </Box>
                                                        <Box display={'flex'} justifyContent={'lex-start'} alignItems={'center'}borderBottom={'1px solid #ebebeb'} pb="10px" pt="10px">
                                                            <Text as="b" w="50%" fontFamily={'Mulish'} style={{fontSize:'14px'}}>Place Of Birth</Text>
                                                            <Text as="p" w="50%" fontFamily={'Mulish'} style={{fontSize:'12px'}} pl="5px">{travellers.placeOfBirth}</Text>
                                                        </Box>
                                                    </Box>
                                                </AccordionPanel>
                                                </Box>
                     ...
                     <Box display={'flex'} justifyContent={'center'} alignItems={'center'} w="100%" pt="15px">
                                    <Button variant="base" w={{base:"100%", md:"50%"}} h="48px" onClick={onOpen}>
                                        Add Travellers
                                    </Button>
                                </Box>
                                <Box display={'flex'} justifyContent={'center'} pb="15px" pt="15px">or</Box>
