...
import { useGetSystemParamsQuery,useGetListCountryQuery } from "./listApiSlice"
...
const Tables = ({
  ...
  pageCount: controlledPageCount}) => {
    ...
    const {
        ...
        response,
        extra
    } = useGetListCountryQuery({ page:pages, size: 10 }, {
  ...
  return (
      ...
      <Box mb="2em" mt="2em">
        <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
                <Heading as={'h6'} size={'sm'}>List Country</Heading>
...
const Country = () => {
    ...
    const {
        ...
        accessHeaders,
        totalCount
    } = useGetListCountryQuery({ page, size: 10 })
