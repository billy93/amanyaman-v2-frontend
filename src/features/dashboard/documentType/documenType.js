...
import {setSystemParams,listSystemParam,setTotalCount} from './docTypeSlice'
...
const filterTypes = React.useMemo(
  ...
  // }
    const handleAdd = (e) => {
        e.preventDefault()
        navigate('/master-data/create-document-type')
    }
  ...
  return (
      ...
      <Box mb="2em" mt="2em">
        <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
                <Heading as={'h6'} size={'sm'}>Document Type</Heading>
