...
import { listAgent,formData,setFormData,listProducts } from './productPriceSlice'
...
function handleSelectProduct(data) {
  ...
  const displayPercent = (percent, fallback, digits = 2) =>
    ...
    return (
        ...
        <Box>
          ...
          <Box width={{base:"100%",md:"540px"}} m="auto" >  
            ...
            <Box >
                ...
                <Box width={{base:"100%",md:"540px"}} m="auto" mb="15px" mt="10px">    
                <Box width={{base:"100%",md:"320px"}} >  
      ...
      <Box display={'flex'} justifyContent={'flex-end'} alignItems={'center'} p="1em">
        <Button variant={'custom'} size="sm"> ADD</Button>
      </Box>
      </>
