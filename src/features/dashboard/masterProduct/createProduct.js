             ...
             <FormControl variant="floating" isRequired fontFamily={'Mulish'} mt="14px" id="float-label"> 
                    <Box className='floating-form'>
                      <Box className='floating-label'>
                        ...
                        <FormLabel fontSize="12" pt="1.5" style={{ transform: isActiveSelectCountry || locationData?.country !=="" ? "translate(0, -19px) scale(0.75)": "",color: isActiveSelectCountry || locationData.country !=="" ?"#065baa" :"", fontSize:"14px" }} fontFamily={'Mulish'}></FormLabel>
                       </Box>
                    </Box>
                    {/* It is important that the Label comes after the Control due to css selectors */}
                </FormControl>
