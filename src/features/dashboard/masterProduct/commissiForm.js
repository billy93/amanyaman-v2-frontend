...
const CommisionForm = () => {
  ...
  const handleNext = async (e) => {
    ...
    const constData = {
      ...
      npwp: true,
      premiumPrice: formstate?.premiumPrice,
      commisionLv1: formstate?.commissionlvl1,
      commisionLv2: formstate?.commissionlvl2,
      commisionLv3: formstate?.commissionlvl3,
      totalCommision: formstate?.totalCommision,
      afterCommisionPrice: formstate?.afterCommisionPrice,
      benefitDoc: formstate.benefitDoc,
      covidDoc: formstate?.covidDoc,
      productBrochure: formstate.productBrochure,
      wordingDoc: formstate.wordingDoc,
      ppn: formstate?.ppn,
      pph23: formstate?.pph23,
      ppnValue: formstate?.ppnValue,
      pph23Value: formstate?.pph23Value,
      ajiPrice: formstate?.ajiPrice,
      variants: [...formstate.variant, { id: formstate?.variant?.id }],
    };
    try {
