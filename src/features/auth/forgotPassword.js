...
const Public = () => {
  ...
  const [sendEmailConfirm, { isLoading, isSuccess, isError }] =
    useSendEmailConfirmMutation();

  const handleSendEmailConf = async (e) => {
    e.preventDefault();
    // setTrigger(true)
    await sendEmailConfirm({ email: userEmail?.email });
  };
  const content = (
    <section className="login-page">
      <Box color="black:500">
        <AbsoluteCenter
          axis="both"
          width={{ base: '100%', xs: '100%', md: '400px' }}
        >
          <Box
            left="0"
            right="0"
          ...
          >
            ...
            {isSuccess ? (
              ...
              <Stack
                ...
                alignItems={'center'}
              >
                <Heading variant="primary" as="div" size="lg">
                  Lupa Kata Sandi?
                </Heading>
                <Box
                  display={'flex'}
                ...
                >
                  <Text
                    ...
                    fontFamily="Mulish"
                  >
                    Jangan khawatir! Pilih detil kontak yang Anda inginkan untuk
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <AiOutlineMail size={'2em'} color="#065BAA" />{' '}
                      <Text
                        as="p"
                        size="sm"
                        style={{ fontSize: '16px' }}
